...
<x-app-layout>
    <h1 class="text-center mt-4">Ajouter un Doubleur</h1>
    <p class="text-center custom-font-size2 italic text-danger">* Veuillez remplir les champs requis</p>
    <form method="post" enctype="multipart/form-data" action="{{route('doubleurs.store')}}">
        @csrf
        <div class="row mt-3">
        ...
        <div class="row mt-3">
            ...
            <input id="prenom" name="prenom" class="form-control" type="text" minlength="2" maxlength="50" required>
            @error('prenom')
                <div class="text-danger text-bold mt-1">* {{$message}}</div>
            @enderror
        </div>
        ...
        <div class="row mt-3">
            ...
            <input id="date_naissance" name="date_naissance" class="form-control" type="date" required>
        ...
        <div class="row mt-3">
            ...
            <input id="lieu_naissance" name="lieu_naissance" class="form-control" type="text" minlength="2" maxlength="50" required>
        ...
        <div class="row mt-3">
            ...
            <input id="annees_pratique" name="annees_pratique" class="form-control" type="number" min="1" max="50" required>
